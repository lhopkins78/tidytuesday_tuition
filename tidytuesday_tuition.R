...
p1 <- ggplot(tuition_clust, aes(x=in_state_total, y=mid_career_pay, size=total_enrollment, shape=type, 
  ...
  geom_text_repel(data=tuition_clust %>% filter(mid_career_pay<100000 & in_state_total>60000), 
                  ...
                  col="black", size=3, nudge_x=-6000, nudge_y=1000) +
                                                    ...
                                                    labs(shape="Public / Private", title="Return on investment?", subtitle="Mid-career pay by total annual in-state tuition cost", size="Total enrollment",
                                                         x="Average total in-state tuition costs", y="Average mid career pay", caption="Sources: Chronicle of Higher Education, Payscale.com c/o TidyTuesday @ https://github.com/rfordatascience/tidytuesday")
...
p3 <- ggplot(tuition_clust_out, aes(x=out_of_state_total, y=mid_career_pay, size=total_enrollment, shape=type, 
  ...
  labs(shape="Public / Private", title="Return on investment?", subtitle="Mid-career pay by total annual out-of-state tuition cost", size="Total enrollment",
       x="Average total out-of-state tuition costs", y="Average mid career pay", caption="Sources: Chronicle of Higher Education, Payscale.com c/o TidyTuesday @ https://github.com/rfordatascience/tidytuesday")
